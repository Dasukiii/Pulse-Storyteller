  ...
  if (showSuccess) {
    return (
        <>
            ...
            `}</style>
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-slate-50 flex items-center justify-center p-4 font-figtree">
    ...
    <>
        ...
        <div className="w-full max-w-3xl">
            ...
            {currentStep === 3 && (
                ...
                <div>
                    ...
                    {actionPlans.map((option) => (
                        ...
                        title={option.title}
                        description={option.description}
                        selected={actionPlanPreference === option.v}
            ...
            <div className="flex gap-4 mt-8 pt-8 border-t border-slate-200">
                ...
                className="ml-auto px-8 py-3 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 disabled:bg-slate-300 disabled:cursor-not-allowed transition-colors"
                >
                {isSubmitting
                    ? 'Saving...'
                    : currentStep === 3
