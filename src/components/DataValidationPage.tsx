  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      const { error: updateError } = await supabase
        ...
        .update({
          status: 'validated',
          raw_data: mappedData, // Note: In real app, you might save mapped_data, not raw_data
      ...
      if (onValidationComplete) {
        // Pass the original rawData, as mapping is done, but the next step might need the original
